...
import type { PreUploadContract } from "@/defined/contract"
...
const tableProps: Ref<TableProps<PreUploadContract>> = ref({
  columns: [
    {
      key: "id", title: "编号",
    },
